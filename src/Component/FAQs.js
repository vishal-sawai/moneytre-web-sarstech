...
function FAQs() {
  ...
  return (
    ...
    <div className="container" data-aos="fade-up">
      ...
      <Link to={'/faqs'} onClick={scrollToTop}><a className="d d-flex justify-content-end orderlg-2">Read More</a></Link>  
        {/* <a href="#" className="d d-flex justify-content-end orderlg-2">Read More</a> */}
      </div>
